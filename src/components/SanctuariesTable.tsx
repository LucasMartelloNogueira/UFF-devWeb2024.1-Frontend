...
export default function SanctuariesTable({
  ...
  const [countrySortState, setCountrySortState] =
    useState<SortOrderState>("none");
  const [countrySortStateIcon, setCountrySortStateIcon] =
    useState(SortOrderNoneIcon);

  const [stateSortState, setStateSortState] = useState<SortOrderState>("none");
  const [stateSortStateIcon, setStateSortStateIcon] =
    useState(SortOrderNoneIcon);
  ...
  const [addressSortState, setAddressSortState] =
    useState<SortOrderState>("none");
  const [addressSortStateIcon, setAddressSortStateIcon] =
    useState(SortOrderNoneIcon);

  const [ownerSortState, setOwnerSortState] = useState<SortOrderState>("none");
  const [ownerSortStateIcon, setOwnerSortStateIcon] =
    useState(SortOrderNoneIcon);
  ...
  useEffect(() => {
    if (!isLoading) {
      fieldsStates[sortField].setStateIcon(
        sortDirection === "asc" ? SortOrderUpIcon : SortOrderDownIcon
      );
    }
      ...
      <thead>
        <tr>
          ...
          <th className="align-middle text-center">
            name{" "}
            <img
              src={nameSortStateIcon}
              alt="Sort-icon"
              style={{ cursor: "pointer" }}
              onClick={() => handleSortState("name")}
            />{" "}
          </th>
          <th className="align-middle text-center">
            country{" "}
            <img
              src={countrySortStateIcon}
              alt="Sort-icon"
              style={{ cursor: "pointer" }}
              onClick={() => handleSortState("country")}
            />{" "}
          </th>
          <th className="align-middle text-center">
            state{" "}
            <img
              src={stateSortStateIcon}
              alt="Sort-icon"
              style={{ cursor: "pointer" }}
              onClick={() => handleSortState("state")}
            />{" "}
          </th>
          <th className="align-middle text-center">
            city{" "}
            <img
              src={citySortStateIcon}
              alt="Sort-icon"
              style={{ cursor: "pointer" }}
              onClick={() => handleSortState("city")}
            />{" "}
          </th>
          <th className="align-middle text-center">
            address{" "}
            <img
              src={addressSortStateIcon}
              alt="Sort-icon"
              style={{ cursor: "pointer" }}
              onClick={() => handleSortState("address")}
            />{" "}
          </th>
          <th className="align-middle text-center">
            owner{" "}
            <img
              src={ownerSortStateIcon}
              alt="Sort-icon"
              style={{ cursor: "pointer" }}
              onClick={() => handleSortState("owner")}
            />{" "}
          </th>
